...
public class RepetitiveStatement {
	...
	public static void main(String[] args) {
		 ...
		 * while문
		 * - while(조건식){}
		 * - 포함하고 있는 문장들은 조건식이 만족하는 동안 반복하는 문장
...
//				continue; //가장 가까운 반복문의 현재 반복회차를 빠져나간다. // 5만 빠져나가고 6부터 다시 반복
//				continue outer; //outer라는 이름의 현재 반복회차를 빠져나가나.  //???????????????
				}
